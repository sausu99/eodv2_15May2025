	...
	if(isset($_POST['user_search']))
	 {
		...
		$user_qry="SELECT * 
                   ...
                   ORDER BY tbl_ticket.ticket_id DESC";  
	 ...
	 else
	 {
							...
							$query = "SELECT COUNT(*) as num FROM $tableName left join tbl_offers on tbl_offers.o_id = tbl_ticket.o_id
		                              WHERE tbl_offers.id = '$id' AND tbl_ticket.o_id = $gameId";
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr> 
		           ...
		           <td><?php echo $client_lang['purchase_date'].': '; ?><?php echo $users_row['purchase_date'];?><br><?php echo $client_lang['ticket_price'].': '; ?><?php echo $users_row['ticket_price'].' '.$client_lang['coin'];?><a href="ticket_purchases.php?lottery_id=<?php echo $users_row['o_id'];?>" class="btn blue-btn" title="<?php echo $client_lang['view_tickets']; ?>"><i class="fa fa-eye"></i>&nbsp;<?php echo $client_lang['view_tickets']; ?></a></td> 
                  <td>
