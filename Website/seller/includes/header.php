<?php 
    ...
    include("includes/session_check.php"); //Verify if seller is logged in to prevent unathorised access
...
<body>
  ...
  <!--  <ul id= "remove" class="notification">-->
        <!--<center><li><div class="icon"> <h5><i class="fi fi-ss-badge-check"></i>&nbsp;&nbsp;<?php echo APP_NAME;?> has been updated with <strong>new features</strong> on August 11, 2024. <a href="update.html" target="_blank">(Know More)</a></h5> </div></li></center>-->
  <!--  </ul>-->
</nav>
...
<div class="app app-default">
  <aside class="app-sidebar" id="sidebar">
    ...
    <?php if($rowPermit['permission_auction'] == 1) { ?>
  ...
  <?php if($rowPermit['permission_lottery'] == 1) { ?>
  <!-- --------------------------------------Sub Menu Start------------------------------------ -->
  <div class="menu-item">
  ...
  <!-- ------------------------------------------Sub Menu End----------------------------------- -->
    ...
    <?php if($rowPermit['permission_shop'] == 1) { ?>
    ...
    <?php if($rowPermit['permission_coin'] == 1) { ?>
        
        <li <?php if($currentFile=="topup_user.php"){?>class="active"<?php }?>> <a href="topup_user.php">
          <div class="icon"> <i class="fa fa-add" aria-hidden="true"></i> </div>
        ...
        <div class="container-fluid">
          <div class="navbar-collapse collapse in">
            <ul class="nav navbar-nav navbar-mobile">
              ...
              <li class="logo">
                <a class="navbar-brand" href="#"><?php echo APP_NAME;?> Seller Panel</a>
              </li>
              <li>
            ...
            <ul class="nav navbar-nav navbar-left">
              <li class="navbar-title">Seller Panel</li>
              <!-- Search bar start -->
              <li class="navbar-search">
                ...
                <ul id="dropdownMenu" class="dropdown-menu">
                  ...
                  <li>
                    <i class="fa fa-add"></i>
                    <a href="topup_user.php">Recharge Wallet</a>
                    <span class="arrow">&rarr;</span>
                  </li>
                  <li>
              ...
              <li class="dropdown profile">
                ...
                <div class="dropdown-menu">
                  <div class="profile-info">
                    <h4 class="username"><i class="fi fi-rs-admin-alt">&nbsp;</i><?php echo $sellerName;?></h4>
                  </div>
                  <ul class="action">
