    ...
    <div class="background-container">
        ...
        <div class="item-details-container">
            <div class="right-side">
                <form id="pmnt-form" action="payment-gateway/mpesa_mz/item_payment-processor.php" method="post">

                    <input type="hidden" name="amount" id="amount" class="payment-selector"
                        value="<?php echo $_POST['amount']; ?>">
                    <input type="hidden" name="item_id" id="item_id" class="payment-selector"
                        value="<?php echo $_POST['item_id']; ?>">
