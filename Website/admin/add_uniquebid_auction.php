...
if (isset($_POST['submit']) && isset($_POST['o_id'])) {
    ...
    if ($user_edit > 0) {
        $_SESSION['msg'] = "35";
        header("Location:add_uniquebid_auction.php?o_id=" . sanitize($_POST['o_id']));
        exit;
    }
}
...
<head>
<title><?php if(isset($_GET['o_id'])){?><?php echo $client_lang['edit']; ?><?php }else{?><?php echo $client_lang['add']; ?><?php }?>&nbsp;<?php echo $client_lang['unique_auction']; ?></title>
</head>
<style>
    .safe-mode-title {
        display: block;
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['o_id'])){?><?php echo $client_lang['edit']; ?><?php }else{?><?php echo $client_lang['add']; ?><?php }?>&nbsp;<?php echo $client_lang['unique_auction']; ?></div>
                    <p class="control-label-help"><?php echo $client_lang['unique_auction_help']; ?><a href="https://documentation.wowcodes.in/guide/unique-bid.html" target="_blank"><?php echo $client_lang['learn_more']; ?> -></a></p>
            </div>
          </div>
            ...
            <form action="" name="addedituser" method="post" class="form form-horizontal" enctype="multipart/form-data" >
              ...
              <div class="section">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo $client_lang['minimum_bid']; ?>:-<br><p class="control-label-help"><?php echo $client_lang['minimum_bid_help']; ?></p></label>
                    <div class="col-md-6">
                         <div class="input-group">
                 ...
                 <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo $client_lang['maximum_bid']; ?>:-<br><p class="control-label-help"><?php echo $client_lang['maximum_bid_help']; ?></p></label>
                    <div class="col-md-6">
                         <div class="input-group">
                             <span class="input-group-addon"><?php
                                     $currency_qry = "SELECT currency FROM tbl_settings";
                      ...
                      <input type="text" name="o_max" id="o_max" title="maximum bid a user can place" placeholder="eg. 90"  value="<?php if(isset($_GET['o_id'])){echo $user_row['o_max'];}?>" class="form-control">
                      </div>
                      </div>
                  </div>

                
                <strong class="safe-mode-title"><?php echo $client_lang['auction_type']; ?></strong>
                  <p class="safe-mode-description"><?php echo '1. Lowest Unique Bid '.$client_lang['type_lub']; ?></p>
                  <p class="safe-mode-description"><?php echo '2. Highest Unique Bid '.$client_lang['type_hub']; ?></p>
                  <hr>
                    
                  
                  <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo $client_lang['auction_type']; ?> :-</label>
                      <div class="col-md-6">                       
                        <select name="o_type" id="o_type" style="width:280px; height:25px;" class="select2" required>
                            <option value="">- <?php echo $client_lang['select_auction_type']; ?> -</option>
                ...
                <p class="safe-mode-description"><?php echo $client_lang['buynow_description']; ?></p>
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      <button type="submit" name="submit" class="btn btn-primary"><?php if(isset($_GET['o_id'])){?><?php echo $client_lang['update']; ?><?php }else{?><?php echo $client_lang['add']; ?><?php }?>&nbsp;<?php echo $client_lang['unique_auction']; ?></button>
                    </div>
                  </div>
                </div>
              </div>
