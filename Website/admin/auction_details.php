...
<div class="container">
    <div class="section">
        ...
        <div class="item-details">
            <strong>Auction Name:</strong> <?php echo $itemName ?><br>
        ...
        <div class="item-details">
            <strong>Total Bids Placed:</strong> <?php echo $totalEntries.' Bids' ?><br>
        </div>
        <div class="item-details">
            <strong>Current Winner:</strong> <?php echo $currentWinningBid['winner']; ?><br>
            <strong>Current Winning Bid:</strong> <?php echo $currency . $currentWinningBid['bid']; ?><br>
        </div>
    ...
    <div class="section">
        <hr>
    <h2 class="section-title">Bids Data</h2>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $rowTopBidders['bid_count']; ?></td>
        ...
        <hr>
        <h3>Datewise Bids Data</h3>
        <div class="chart-container">
            <canvas id="bidsChart"></canvas>
        </div>
        <hr>
        <div class="table-container">
            <h3>Recent Bids &nbsp;<a href="participations.php?game_id=<?php echo $itemId;?>" class="btn blue-btn">View All Bids</a></h3>
            <table>
                <thead>
                    <tr>
                        <th>Bidder</th>
                ...
                <tbody>
                    <?php while ($rowRecentBids = mysqli_fetch_assoc($resultRecentBids)) { ?>
                    <tr>
                        <td><?php echo $rowRecentBids['name']; ?></td>
                        <td><?php echo $currency.$rowRecentBids['bd_value']; ?></td>
