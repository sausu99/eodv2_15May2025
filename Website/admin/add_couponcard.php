...
// Handle form submission for adding a new scratch card
...
// Handle form submission for updating an existing scratch card
if (isset($_POST['submit']) && isset($_POST['s_id'])) {
    $data = array(
        's_name'  => sanitize($_POST['s_name']),
        's_desc'  => sanitize($_POST['s_desc']),
        's_colour'  => sanitize($_POST['s_colour']),
    ...
    if ($user_edit > 0) {
        ...
        header("Location:add_couponcard.php?s_id=" . sanitize($_POST['s_id']));
        exit;
    }
}

if (isset($_GET['s_id'])) {
    $user_qry = "SELECT * FROM tbl_scratch WHERE s_id='" . sanitize($_GET['s_id']) . "'";
        ...
        <div class="card">
            <div class="page_title_block">
                <div class="col-md-5 col-xs-12">
                    ...
                    <p class="control-label-help"><?php echo $client_lang['add_coupon_card']; ?></p>
                </div>
            </div>
                ...
                <form action="" name="addedituser" method="post" class="form form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="section" id="section2" style="display:none;">
                        <div class="section-body">
                            ...
                            <div class="form-group">
                              <label class="col-md-3 control-label"><?php echo $client_lang['scratch_card_coupon_code']; ?>:-<br><p class="control-label-help"><?php echo $client_lang['scratch_card_coupon_code_help']; ?></p></label>
                              <div class="col-md-6">
                                <input type="text" name="s_code" id="s_code" placeholder="#90OFFCOUPON" title="coupon code user needs to redeem" value="<?php if(isset($_GET['s_id'])){echo $user_row['s_code'];}?>" class="form-control" required>
                              </div>
                            </div>
                            
                             <div class="form-group">
                              <label class="col-md-3 control-label"><?php echo $client_lang['scratch_card_coupon_link']; ?>:-<br><p class="control-label-help"><?php echo $client_lang['scratch_card_coupon_link_help']; ?></p></label>
                              <div class="col-md-6">
                                <input type="text" name="s_link" id="s_link" placeholder="eg. wowcodes.in" title="link where user needs to redeem" value="<?php if(isset($_GET['s_id'])){echo $user_row['s_link'];}?>" class="form-control">
                              </div>
                            </div>
                            <br>
