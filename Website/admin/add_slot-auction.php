...
if (isset($_POST['submit']) and isset($_POST['o_id'])) {
    ...
    if ($user_edit > 0) {
        $_SESSION['msg'] = "35";
        header("Location:add_slot-auction.php?o_id=" . sanitize($_POST['o_id']));
        exit;
    }
}
...
<head>
<title><?php if(isset($_GET['o_id'])){?><?php echo $client_lang['edit']; ?><?php }else{?><?php echo $client_lang['add']; ?><?php }?>&nbsp;<?php echo $client_lang['slot_auction']; ?></title>
</head>
<style>
    .safe-mode-title {
        display: block;
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['o_id'])){?><?php echo $client_lang['edit']; ?><?php }else{?><?php echo $client_lang['add']; ?><?php }?>&nbsp;<?php echo $client_lang['slot_auction']; ?></div>
                    <p class="control-label-help"><?php echo $client_lang['slot_auction_help']; ?><a href="https://documentation.wowcodes.in/guide/slot-auction.html" target="_blank"><?php echo $client_lang['learn_more']; ?> -></a></p>
            </div>
          </div>
            ...
            <form action="" name="addedituser" method="post" class="form form-horizontal" enctype="multipart/form-data" >
              ...
              <div class="section">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo $client_lang['slot_price']; ?>:-<br><p class="control-label-help"><?php echo $client_lang['slot_price_help']; ?></p></label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo $client_lang['maximum_slot']; ?>:-<br><p class="control-label-help"><?php echo $client_lang['maximum_slot_help']; ?></p></label>
                    <div class="col-md-6">
                         <div class="input-group">
                      <input type="text" name="o_amount" id="o_max" placeholder="eg. 1"  value="<?php if(isset($_GET['o_id'])){echo $user_row['o_max'];}?>" class="form-control" required>
                ...
                <p class="safe-mode-description"><?php echo $client_lang['buynow_description']; ?></p>
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      <button type="submit" name="submit" class="btn btn-primary"><?php if(isset($_GET['o_id'])){?><?php echo $client_lang['update']; ?><?php }else{?><?php echo $client_lang['add']; ?><?php }?>&nbsp;<?php echo $client_lang['slot_auction']; ?></button>
                    </div>
                  </div>
                </div>
              </div>
