/**
 * The `AllLottoAdapter` class is a RecyclerView adapter used to display a list of bids in a card view
 * format.
 */
...
public class AllLottoAdapter extends RecyclerView.Adapter<AllLottoAdapter.ViewHolder> {
    ...
    public AllLottoAdapter(Context context, ArrayList<AllBid> coinModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.txtAmount.setText("" + coinModelArrayList.get(position).getTotal_amount() + " "+mContext.getResources().getString(R.string.string206));
        holder.txtBids.setText(mContext.getResources().getString(R.string.string201)+" " + coinModelArrayList.get(position).getBd_value());
