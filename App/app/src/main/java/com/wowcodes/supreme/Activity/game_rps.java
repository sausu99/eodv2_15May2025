...
public class game_rps extends AppCompatActivity {

    ImageView user_move_img,computer_move_img,scissorsBtn,rockBtn,paperBtn,imgBackk;
    TextView winner_tv,txtGetCoinTop,underline,submit,rps_min,rps_max,rps_win,rps_chance,compname;
    EditText noofcoins;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAucname.setText(getResources().getString(R.string.rps));
        ...
        rps_min=findViewById(R.id.rps_min);
        rps_max=findViewById(R.id.rps_max);
        rps_win=findViewById(R.id.rps_win);
        rps_chance=findViewById(R.id.rps_chance);
        ...
        savePref=new SavePref(game_rps.this);
        ...
        animation.addFrame(getResources().getDrawable(R.drawable.rps_stone), 700);
        animation.addFrame(getResources().getDrawable(R.drawable.rps_paper), 700);
        animation.addFrame(getResources().getDrawable(R.drawable.rps_scissors), 700);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(noofcoins.getText().toString().isEmpty())
                    Toast.makeText(game_rps.this, getResources().getString(R.string.entervaluefirst), Toast.LENGTH_SHORT).show();
                else if(Integer.parseInt(noofcoins.getText().toString())>Integer.parseInt(txtGetCoinTop.getText().toString()))
                    Toast.makeText(game_rps.this, getResources().getString(R.string.donthaveenoughcoins), Toast.LENGTH_SHORT).show();
                else if(Integer.parseInt(noofcoins.getText().toString())<Integer.parseInt(rps_min.getText().toString()))
                    Toast.makeText(game_rps.this, getResources().getString(R.string.minbidallowed)+" "+rps_min.getText().toString(), Toast.LENGTH_SHORT).show();
                else if(Integer.parseInt(noofcoins.getText().toString())>Integer.parseInt(rps_max.getText().toString()))
                    Toast.makeText(game_rps.this, getResources().getString(R.string.maxbidallowed)+" "+rps_max.getText().toString(), Toast.LENGTH_SHORT).show();
                else if (set==0)
                        Toast.makeText(game_rps.this, getResources().getString(R.string.selectmovefirst), Toast.LENGTH_SHORT).show();
                else {
                    ...
                    double bonus=(Double.parseDouble(rps_win.getText().toString())*0.01);
                    coinValue = coins + (int) Math.ceil(coins * bonus);

                    int computer_move = new Random().nextInt(3) + 1;

                    if (set==1){
                        if(Integer.parseInt(rps_chance.getText().toString()) == 0)
                            computer_move=2;
                        if (computer_move == 1) {
                            computer_move_img.setImageDrawable(getResources().getDrawable(R.drawable.rps_stone));
                            winner_tv.setText("- IT'S A DRAW -");
                        } else if (computer_move == 2) {
                            computer_move_img.setImageDrawable(getResources().getDrawable(R.drawable.rps_paper));
                            winner_tv.setText("OOPS!.\nYOU LOST!..\n\n" + noofcoins.getText().toString() + " COINS HAVE BEEN DEDUCTED FROM YOUR ACCOUNT..");
                        } else {
                            computer_move_img.setImageDrawable(getResources().getDrawable(R.drawable.rps_scissors));
                    ...
                    Dialog dialog=new Dialog(game_rps.this);
                    ...
                    okay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            set=0;
                            noofcoins.setText("");
                            rockBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_stone));
                            paperBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_paper));
                            scissorsBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_scissors));
                            reload();
                        }
                    });
                    dialog.show();
        ...
        rockBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(noofcoins.getText().toString().isEmpty())
                    ...
                    set = 1;
                    user_move_img.setImageDrawable(getResources().getDrawable(R.drawable.rps_stone));
                    rockBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_stone_sel));
                    paperBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_paper));
                    scissorsBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_scissors));
                }
            }
        ...
        paperBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(noofcoins.getText().toString().isEmpty())
                    ...
                    set = 2;
                    user_move_img.setImageDrawable(getResources().getDrawable(R.drawable.rps_paper));
                    paperBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_paper_sel));
                    rockBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_stone));
                    scissorsBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_scissors));
                }
            }
        ...
        scissorsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(noofcoins.getText().toString().isEmpty())
                    ...
                    set = 3;
                    user_move_img.setImageDrawable(getResources().getDrawable(R.drawable.rps_scissors));
                    scissorsBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_scissors_sel));
                    rockBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_stone));
                    paperBtn.setImageDrawable(getResources().getDrawable(R.drawable.rps_paper));
                }
            }
        ...
        underline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dialog dialog2=new Dialog(game_rps.this);
                ...
                textview2.setText(getText(R.string.gamerules)+"\n\n"+getText(R.string.minbet)+rps_min.getText().toString()+"\n"+getText(R.string.maxbet)+rps_max.getText().toString()+"\n"+getText(R.string.winbonus)+rps_win.getText().toString()+"\n"+getText(R.string.winchance)+rps_chance.getText().toString()+"\n\n"+getText(R.string.steps)+"\n\n"+getText(R.string.step1)+"\n\n"+getText(R.string.rpsstep2)+"\n\n"+getText(R.string.rpsstep3)+"\n\n"+getText(R.string.rpsstep4)+"\n\n"+getText(R.string.bestofluck));
        ...
        try {
            videoService.getUserProfile(savePref.getUserId()).enqueue(new Callback<UserProfile>() {
                ...
                public void onFailure(Call<UserProfile> call, Throwable t) {
                    //Toast.makeText(game_rps.this, "ERROR GETTING COINS", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
            ...
            videoService.get_games().enqueue(new Callback<GetGames>() {
                ...
                public void onResponse(Call<GetGames> call, retrofit2.Response<GetGames> response) {
                    try {
                        ...
                        rps_min.setText(arrayList.get(0).getRps_min());
                        rps_max.setText(arrayList.get(0).getRps_max());
                        rps_win.setText(arrayList.get(0).getRps_win());
                        rps_chance.setText(arrayList.get(0).getRps_chance());
    ...
    public void reload(){
        Intent i = new Intent(this, game_rps.class);
