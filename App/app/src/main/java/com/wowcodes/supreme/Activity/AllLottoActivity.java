/**
 * The AllLottoActivity class is an AppCompatActivity that retrieves a list of bidders from an API and
...
import android.graphics.drawable.Drawable;
        ...
        import com.wowcodes.supreme.Adapter.AllLottoAdapter;
...
public class AllLottoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savePref = new SavePref(AllLottoActivity.this);
        ...
        recyclerAllBidder.setLayoutManager(new LinearLayoutManager(AllLottoActivity.this));
        ...
        try {
            videoService.get_offers_id(oId, savePref.getUserId()).enqueue(new Callback<AllBidder>() {
                ...
                public void onResponse(Call<AllBidder> call, retrofit2.Response<AllBidder> response) {
                    ...
                    recyclerAllBidder.setAdapter(new AllLottoAdapter(AllLottoActivity.this, arrayList));
                    if (arrayList.size() == 0)
