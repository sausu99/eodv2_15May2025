...
public class SelectAddressAdapter extends RecyclerView.Adapter<SelectAddressAdapter.ItemViewHolder> {
    ...
    public SelectAddressAdapter(Context context, ArrayList<AddressResponse2.Address> addressesList, String oid, String oamt, String otype,String itemid) {
    ...
    public void addclaimbid(String address) {
        try {
            ...
            apiService.add_order(new SavePref(context).getUserId(),oid,oamt,"",oamt,address,itemid,"1").enqueue(new Callback<AddOrder>() {
                @Override
