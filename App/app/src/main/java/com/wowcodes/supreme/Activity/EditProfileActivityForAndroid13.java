...
public class EditProfileActivityForAndroid13 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        savePref = new SavePref(EditProfileActivityForAndroid13.this);
    ...
    private boolean validation() {
        try {
            if (txtEmailId.getText().toString().equalsIgnoreCase(" ") || !isValidMail(txtEmailId.getText().toString())) {
                Toast.makeText(EditProfileActivityForAndroid13.this, R.string.string152, Toast.LENGTH_LONG).show();
                return false;
            } else if (TextUtils.isEmpty(txtYourName.getText().toString())) {
                Toast.makeText(EditProfileActivityForAndroid13.this, R.string.string154, Toast.LENGTH_LONG).show();
                return false;
            }
                ...
                public void onResponse(Call<UserProfile> call, retrofit2.Response<UserProfile> response) {
                    try {
                        ...
                        if (arrayList.get(0).getImage().equalsIgnoreCase("")) {
                            try {
                                Glide.with(EditProfileActivityForAndroid13.this)
    ...
    public void imageAddapi() {
        ...
        callimageAddapi().enqueue(new Callback<SuccessModel>() {
            ...
            public void onResponse(Call<SuccessModel> call, retrofit2.Response<SuccessModel> response) {
                try {
                    Toast.makeText(EditProfileActivityForAndroid13.this, "" + response.body().getJSON_DATA().get(0).getMsg(), Toast.LENGTH_SHORT).show();
                    if (response.body().getJSON_DATA().get(0).getSuccess().equalsIgnoreCase("1")) {
                        StaticData.userProfileList.clear();
                        Intent i = new Intent(EditProfileActivityForAndroid13.this, MainActivity.class);
    ...
    public void checkPermissionOfStorage() {
        ...
        Dexter.withContext(EditProfileActivityForAndroid13.this).withPermissions(permissions).withListener(new MultiplePermissionsListener() {
            @Override
    ...
    private boolean checkRead() {
        ...
        int res = EditProfileActivityForAndroid13.this.checkCallingOrSelfPermission(permission);
