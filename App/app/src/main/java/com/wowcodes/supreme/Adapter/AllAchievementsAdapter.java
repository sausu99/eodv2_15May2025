...
public class AllAchievementsAdapter extends RecyclerView.Adapter<AllAchievementsAdapter.ViewHolder>{
    ...
    public AllAchievementsAdapter(Context context, ArrayList<GetAchievements.Get_Achievements_Inner> coinModelArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_achievements_all, parent, false);
